  ...
  return (
    <div className="mx-auto max-w-7xl px-5 py-10">
      <header className="mb-8">
        <h1 className="font-display text-4xl font-semibold text-navy-900">Explore listings</h1>
      ...
      <div className="grid gap-8 lg:grid-cols-[300px_1fr]">
        ...
        <div>
          ...
          {status === 'done' && (
            <>
              <p className="mb-4 text-sm text-slate/60">{items.length} home{items.length !== 1 && 's'} found</p>
