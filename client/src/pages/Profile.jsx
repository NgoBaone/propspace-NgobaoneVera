...
export default function Profile() {
  ...
  return (
    <div className="mx-auto max-w-3xl px-5 py-10">
      <h1 className="font-display text-4xl font-semibold text-navy-900">Account settings</h1>
      <p className="mt-1 text-slate/60">Manage your profile and security.</p>

      {/* Profile */}
      <section className="mt-8 rounded-3xl border border-line bg-white p-6 shadow-card">
        <h2 className="flex items-center gap-2 font-display text-xl font-semibold text-navy-800">
          <UserRound className="h-5 w-5 text-navy-500" /> Profile
        </h2>
        ...
        <div className="mt-5 flex items-center gap-4">
          {profile.avatar ? (
            ...
            <span className="grid h-16 w-16 place-items-center rounded-2xl bg-navy-50 text-2xl font-semibold text-navy-700">
      ...
      <section className="mt-6 rounded-3xl border border-line bg-white p-6 shadow-card">
        <h2 className="flex items-center gap-2 font-display text-xl font-semibold text-navy-800">
          <KeyRound className="h-5 w-5 text-navy-500" /> Change password
        </h2>
