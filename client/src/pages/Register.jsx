    ...
    <div className="mx-auto flex min-h-[70vh] max-w-md flex-col justify-center px-5 py-12">
      <div className="rounded-3xl border border-line bg-white p-8 shadow-card animate-fade-up">
        <div className="mb-6 text-center">
          ...
          <h1 className="mt-4 font-display text-3xl font-semibold text-navy-900">Create your account</h1>
          <p className="mt-1 text-slate/60">Start listing and managing properties.</p>
        </div>
        ...
        <div className="space-y-4">
          <div>
            ...
            <div className="relative">
              <User className="pointer-events-none absolute left-3 top-1/2 h-4 w-4 -translate-y-1/2 text-slate/40" />
          ...
          <div>
            ...
            <div className="relative">
              <Mail className="pointer-events-none absolute left-3 top-1/2 h-4 w-4 -translate-y-1/2 text-slate/40" />
          ...
          <div>
            ...
            <div className="relative">
              <Lock className="pointer-events-none absolute left-3 top-1/2 h-4 w-4 -translate-y-1/2 text-slate/40" />
        ...
        <p className="mt-6 text-center text-sm text-slate/60">
          ...
          <Link to="/login" className="font-semibold text-navy-600 hover:text-navy-700">
            Log in
          </Link>
        </p>
      </div>
